...
func create_tables() {
	...
	execSQL("CREATE TABLE IF NOT EXISTS problems (id INT AUTO_INCREMENT NOT NULL, teacher_id INT, course_id VARCHAR(50) NOT NULL, problem_description TEXT, answer TEXT, filename TEXT, merit INT, effort INT, attempts INT, topic_id INT, tag INT, problem_uploaded_at TIMESTAMP, problem_ended_at TIMESTAMP, class_feedback LONGTEXT, PRIMARY KEY (`id`))")
